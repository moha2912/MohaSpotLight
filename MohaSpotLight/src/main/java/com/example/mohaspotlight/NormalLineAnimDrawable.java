...
public class NormalLineAnimDrawable extends Drawable implements ValueAnimator.AnimatorUpdateListener {
    ...
    private com.indimed.babyyodas.utils.spotligh.AnimPoint curAnimPoint = null;
    private int moveTimes;
    private List<com.indimed.babyyodas.utils.spotligh.AnimPoint> mAnimPoints = new ArrayList<com.indimed.babyyodas.utils.spotligh.AnimPoint>();
    ...
    public void playAnim(List<com.indimed.babyyodas.utils.spotligh.AnimPoint> animPoints) {
        if (animPoints != null) {
    ...
    private void drawLine(List<com.indimed.babyyodas.utils.spotligh.AnimPoint> animPoints, int num) {
        drawLine(animPoints, num, animPoints.size());
    }

    private void drawLine(List<com.indimed.babyyodas.utils.spotligh.AnimPoint> animPoints, int num, int size) {
        for (int i = num, j = size; i < j; i++) {
            com.indimed.babyyodas.utils.spotligh.AnimPoint p = animPoints.get(i);
    ...
    public List<com.indimed.babyyodas.utils.spotligh.AnimPoint> getPoints() {
        return mAnimPoints;
    }

    public void setPoints(List<com.indimed.babyyodas.utils.spotligh.AnimPoint> animPoints) {
        mAnimPoints = animPoints;
    }
